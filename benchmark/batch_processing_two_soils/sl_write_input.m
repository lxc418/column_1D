...
fil.terms.('inp').('fname')  = 'COLUMN.inp' ; fil.terms.('inp').('fid')   = 50;
fil.terms.('ics').('fname')  = 'COLUMN.ics' ; fil.terms.('ics').('fid')   = 55;
fil.terms.('lst').('fname')  = 'COLUMN.lst' ; fil.terms.('lst').('fid')   = 60;
fil.terms.('rst').('fname')  = 'COLUMN.rst' ; fil.terms.('rst').('fid')   = 66;
fil.terms.('nod').('fname')  = 'COLUMN.nod' ; fil.terms.('nod').('fid')   = 30;
fil.terms.('ele').('fname')  = 'COLUMN.ele' ; fil.terms.('ele').('fid')   = 40;
fil.terms.('obs').('fname')  = 'COLUMN.obs' ; fil.terms.('obs').('fid')   = 70;
fil.terms.('smy').('fname')  = 'COLUMN.smy' ; fil.terms.('smy').('fid')   = 80;
fil.terms.('bcof').('fname') = 'COLUMN.bcof'; fil.terms.('bcof').('fid')  = 91;
fil.terms.('bcos').('fname') = 'COLUMN.bcos'; fil.terms.('bcos').('fid')  = 93;
fil.terms.('bcop').('fname') = 'COLUMN.bcop'; fil.terms.('bcop').('fid')  = 92;
fil.terms.('bcou').('fname') = 'COLUMN.bcou'; fil.terms.('bcou').('fid')  = 94;
...
time_scale=10; 
time_cycle=60480%around 6 days
...
water_table_m = y(3,2) - water_depth_m/100;
...
inp.atmax   =zeros(ne,1)+0.0001;
inp.atmin   =zeros(ne,1)+0.0001;
